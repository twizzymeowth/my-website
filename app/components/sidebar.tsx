...
const socialLinks = [
  {
    label: "GitHub",
    href: "#" /* PLACEHOLDER: Replace with your GitHub URL */,
    icon: (
      ...
      <div className="rounded-lg bg-surface p-4">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent text-accent-foreground text-sm font-bold">
            CK{/* PLACEHOLDER: Replace with your initials */}
          </div>
          <div>
            <p className="text-sm font-semibold text-foreground">Chris Kundrat</p>{/* PLACEHOLDER: Replace with your name */}
            <p className="text-xs text-muted-foreground">Cybersecurity</p>{/* PLACEHOLDER: Replace with your field */}
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col justify-between rounded-lg bg-surface p-4">
        <div>
          ...
          <div className="flex flex-col gap-2">
            <a
              href="https://drive.google.com/file/d/118fb8ooXrzbzYiNPpjoBK0kmzlibZGmr/view?usp=drive_link" /* PLACEHOLDER: Replace with your document link */
              target="_blank"
            ...
            <a
              href="mailto:ckundrat@odu.edu" /* PLACEHOLDER: Replace with your email */
              className="flex items-center gap-2 rounded-md px-3 py-2 text-sm text-muted-foreground transition-colors hover:text-foreground"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
